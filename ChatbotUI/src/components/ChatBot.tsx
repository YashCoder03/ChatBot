...
export default function Chatbot() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-[#eee0e0] dark:bg-gray-800">
      <div className="flex flex-col w-full max-w-3xl h-[700px] border border-gray-700 rounded-2xl shadow-lg bg-gray-800 overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-3 bg-stone-100 dark:bg-gray-900 text-white">
        ...
        <div className="pb-4 px-2 border-gray-700 bg-stone-100 dark:bg-gray-900 flex gap-2 items-center">
          <input
            type="text"
